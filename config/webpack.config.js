...
import ForkTsCheckerWarningWebpackPlugin from 'react-dev-utils/ForkTsCheckerWarningWebpackPlugin.js';
...
// Conditionally import the correct ForkTsCheckerWebpackPlugin based on the environment
const ForkTsCheckerPlugin =
  process.env.TSC_COMPILE_ON_ERROR === 'true'
    ? ForkTsCheckerWarningWebpackPlugin
    : ForkTsCheckerWebpackPlugin;

export { ForkTsCheckerPlugin, ReactRefreshWebpackPlugin, createEnvironmentHash };
...
// Importing react-refresh and its plugin
const reactRefreshRuntimeEntry = resolve('react-refresh/runtime');
const reactRefreshWebpackPluginRuntimeEntry = resolve(
  '@pmmmwh/react-refresh-webpack-plugin'
);

// Importing Babel runtime entries
const babelRuntimeEntry = resolve('babel-preset-react-app');
const babelRuntimeEntryHelpers = resolve(
  '@babel/runtime/helpers/esm/assertThisInitialized',
  { paths: [babelRuntimeEntry] }
);
const babelRuntimeRegenerator = resolve('@babel/runtime/regenerator', {
  paths: [babelRuntimeEntry],
});
